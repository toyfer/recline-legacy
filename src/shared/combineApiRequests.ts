...
/**
 * Combines API request start and finish messages in an array of ReclineMessages.
 *
 ...
 * @returns A new array of ReclineMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: ReclineMessage[]): ReclineMessage[] {
  const combinedApiRequests: ReclineMessage[] = [];
