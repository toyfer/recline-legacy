 ...
 *
 * This function processes an array of ReclineMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of ReclineMessage objects to process.
 * @returns A new array of ReclineMessage objects with command sequences combined.
 *
 * @example
 * const messages: ReclineMessage[] = [
 ...
 */
export function combineCommandSequences(messages: ReclineMessage[]): ReclineMessage[] {
  const combinedCommands: ReclineMessage[] = [];
