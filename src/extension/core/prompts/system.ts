...
const isValidForecastArgs = (
  ...
  (args.days == null || typeof args.days === 'number');
...
export function addUserInstructions(settingsCustomInstructions?: string, reclineRulesFileInstructions?: string) {
  let customInstructions = "";
  if (settingsCustomInstructions) {
    customInstructions += `${settingsCustomInstructions}\n\n`;
  }
  if (reclineRulesFileInstructions) {
