...
interface ChatRowProps {
  message: ReclineMessage;
  isExpanded: boolean;
  onToggleExpand: () => void;
  lastModifiedMessage?: ReclineMessage;
  isLast: boolean;
...
export function ChatRowContent({
  message,
  isExpanded,
  onToggleExpand,
  lastModifiedMessage,
    ...
    switch (type) {
      ...
      case "mistake_limit_reached":
        return [
          ...
          <span style={{ color: errorColor, fontWeight: "bold" }}>Recline is having trouble...</span>
        ];
      ...
      case "command":
        return [
          ...
          <span style={{ color: normalColor, fontWeight: "bold" }}>
            {message.type === "ask"
              ? "Recline wants to execute this command:"
              : "Recline executed this command:"}
          </span>
        ];
      case "use_mcp_server":
        const mcpServerUse = JSON.parse(message.text || "{}") as ReclineAskUseMcpServer;
        return [
            ...
            {message.type === "ask"
              ...
              : (
                <>
                  Recline
                  {" "}
                  {mcpServerUse.type === "use_mcp_tool" ? "used a tool" : "accessed a resource"}
                  {" "}
                  on
                  the
                  <code>{mcpServerUse.serverName}</code>
      ...
      case "followup":
        return [
          ...
          <span style={{ color: normalColor, fontWeight: "bold" }}>Recline has a question:</span>
        ];
      default:
        return [null, null];
    }
  ...
  const tool = useMemo(() => {
    if (message.ask === "tool" || message.say === "tool") {
      return JSON.parse(message.text || "{}") as ReclineSayTool;
    }
    return null;
  ...
  if (tool) {
    ...
    switch (tool.tool) {
          ...
          <>
            <div style={headerStyle}>
              ...
              <span style={{ fontWeight: "bold" }}>
                {message.type === "ask"
                  ? "Recline wants to edit this file:"
                  : "Recline is editing this file:"}
              </span>
            </div>
            <CodeAccordian
        ...
        return (
          <>
            <div style={headerStyle}>
              ...
              <span style={{ fontWeight: "bold" }}>
                {message.type === "ask"
                  ? "Recline wants to create a new file:"
                  : "Recline is creating a new file:"}
              </span>
            </div>
            <CodeAccordian
              isLoading={message.partial}
        ...
        return (
          <>
            <div style={headerStyle}>
              {toolIcon("file-code")}
              <span style={{ fontWeight: "bold" }}>
                {message.type === "ask" ? "Recline wants to read this file:" : "Recline read this file:"}
              </span>
            </div>
            {/* <CodeAccordian
							code={tool.content!}
            ...
            >
              <div
                ...
                onClick={() => {
                  vscodeApiWrapper.postMessage({ type: "openFile", text: tool.content });
                }}
              >
        ...
        return (
          <>
            <div style={headerStyle}>
              ...
              <span style={{ fontWeight: "bold" }}>
                {message.type === "ask"
                  ? "Recline wants to view the top level files in this directory:"
                  : "Recline viewed the top level files in this directory:"}
              </span>
            </div>
            <CodeAccordian
              code={tool.content}
        ...
        return (
          <>
            <div style={headerStyle}>
              ...
              <span style={{ fontWeight: "bold" }}>
                {message.type === "ask"
                  ? "Recline wants to recursively view all files in this directory:"
                  : "Recline recursively viewed all files in this directory:"}
              </span>
            </div>
            <CodeAccordian
              code={tool.content}
        ...
        return (
          <>
            <div style={headerStyle}>
              ...
              <span style={{ fontWeight: "bold" }}>
                {message.type === "ask"
                  ? "Recline wants to view source code definition names used in this directory:"
                  : "Recline viewed source code definition names used in this directory:"}
              </span>
            </div>
            <CodeAccordian
              code={tool.content}
      ...
      case "searchFiles":
            ...
            <div style={headerStyle}>
              ...
              <span style={{ fontWeight: "bold" }}>
                {message.type === "ask"
                  ? (
                    <>
                      Recline wants to search this directory for
                      {" "}
                  ...
                  : (
                    <>
                      Recline searched this directory for
                      {" "}
                      <code>{tool.regex}</code>
                      :
                    </>
        ...
        // 				<span style={{ fontWeight: "bold" }}>
        // 					{message.type === "ask" ? (
        // 						<>Recline wants to inspect this website:</>
        // 					) : (
        // 						<>Recline is inspecting this website:</>
        // 					)}
        // 				</span>
        // 			</div>
        // 			<div
  ...
  if (message.ask === "use_mcp_server" || message.say === "use_mcp_server") {
    const useMcpServer = JSON.parse(message.text || "{}") as ReclineAskUseMcpServer;
    ...
    case "say":
      switch (message.say) {
                  ...
                  <p style={{ ...pStyle, color: "var(--vscode-errorForeground)" }}>
                    ...
                    {apiRequestFailedMessage?.toLowerCase().includes("powershell") && (
                      <>
                        ...
                        {" "}
                        <a
                          href="https://github.com/recline/recline/wiki/TroubleShooting-%E2%80%90-%22PowerShell-is-not-recognized-as-an-internal-or-external-command%22"
        ...
        case "user_feedback_diff":
          const tool = JSON.parse(message.text || "{}") as ReclineSayTool;
          return (
            <div
              style={{
                marginTop: -10,
          ...
          return (
            <>
              ...
              >
                ...
                <div>
                  Recline won't be able to view the command's output. Please update VSCode (
                  <code>CMD/CTRL + Shift + P</code>
                  {" "}
                  → "Update") and make sure you're using a supported
                  ...
                  {" "}
                  <a
                    href="https://github.com/recline/recline/wiki/Troubleshooting-%E2%80%90-Shell-Integration-Unavailable"
                    style={{ color: "inherit", textDecoration: "underline" }}
                  >
