    ...
    >
      ...
      {isExpanded && (
        <div style={{ padding: "0" }}>
          ...
          >
            Auto-approve allows Recline to perform the following actions without asking for permission. Please
          ...
          >
            Recline will automatically make this many API requests before asking for approval to proceed with
            the task.
          </div>
          <div style={{ margin: "6px 0" }}>
            ...
            >
              Receive system notifications when Recline requires approval to proceed or when a task is
              completed.
            </div>
          </div>
        </div>
