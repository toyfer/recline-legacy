    ...
    >
      ...
      <div style={{ flex: 1, overflow: "auto", padding: "0 20px" }}>
        ...
        >
          ...
          to extend Recline's capabilities. You can use
          {" "}
          <VSCodeLink href="https://github.com/modelcontextprotocol/servers" style={{ display: "inline" }}>
            community-made servers
          </VSCodeLink>
          {" "}
          or ask Recline to create new tools specific to your workflow (e.g., "add a tool that gets the latest
          npm docs").
          {" "}
        ...
        <div style={{ marginTop: "10px", width: "100%" }}>
          <VSCodeButton
            ...
            style={{ width: "100%" }}
            onClick={() => {
              vscodeApiWrapper.postMessage({ type: "openMcpSettings" });
            }}
          >
